/**
 * Register Component — Mundo Aimas
 * Pantalla de registro con email/password y Google OAuth.
 */
    ...
    return (
      <div className="auth-container">
        <div className="auth-card">
          ...
          <button className="auth-submit" onClick={onSwitchToLogin}>
            Ir a Iniciar Sesión
          </button>
        </div>
      </div>
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        <div className="auth-logo">
          <h1>🏗️ Mundo Aimas</h1>
          <p>Crea tu cuenta y digitaliza tu negocio</p>
        </div>
