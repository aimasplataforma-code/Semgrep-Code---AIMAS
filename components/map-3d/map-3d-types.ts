...
// FIX: Explicitly import the module being augmented so TypeScript can find it in the type space.
...
// The <gmp-map-3d> custom-element is already added to JSX.IntrinsicElements 
// by the @vis.gl/react-google-maps package.
